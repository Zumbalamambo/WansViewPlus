...
public class ErrorCodeAttribute extends Attribute {
     ...
     * @throws net.java.stun4j.StunException if errorCode is not a valid error code.
     */
     ...
     * @throws net.java.stun4j.StunException if errorNumber is not a valid error number.
     */
     ...
     * @throws net.java.stun4j.StunException if errorClass is not a valid error class.
     */
    ...
    public boolean equals(Object obj) {
        ...
        return !(att.getAttributeType() != getAttributeType()
     ...
     * @throws net.java.stun4j.StunException if attrubteValue contains invalid data.
     */
