 ...
 */
package net.ajcloud.wansview.support.core.okhttp.db;
...
import net.ajcloud.wansview.support.core.okhttp.cookie.SerializableCookie;
import net.ajcloud.wansview.support.core.okhttp.db.ColumnEntity;
import net.ajcloud.wansview.support.core.okhttp.db.DBUtils;
import net.ajcloud.wansview.support.core.okhttp.db.TableEntity;
import net.ajcloud.wansview.support.core.okhttp.model.Progress;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (net.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, cacheTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_CACHE);
        if (net.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, cookieTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_COOKIE);
        if (net.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, downloadTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_DOWNLOAD);
