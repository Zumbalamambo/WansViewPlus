...
import net.ajcloud.wansview.support.core.okhttp.db.BaseDao;
import net.ajcloud.wansview.support.core.okhttp.db.DBHelper;
...
public class DownloadManager extends BaseDao<Progress> {
    ...
    private DownloadManager() {
        super(new net.ajcloud.wansview.support.core.okhttp.db.DBHelper());
    }
    ...
    public String getTableName() {
        return net.ajcloud.wansview.support.core.okhttp.db.DBHelper.TABLE_DOWNLOAD;
    }
