...
//                        多指时处理屏幕缩放
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        isScalable = typedArray.getBoolean(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_scaleable, false);
        minScale = typedArray.getFloat(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_minScale, 1.0f);
        maxScale = typedArray.getFloat(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_maxScale, 4.0f);
        isDragable = typedArray.getBoolean(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_dragable, false);
        isSlideable = typedArray.getBoolean(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_dragSlideable, true);
        slideRangeX = typedArray.getInt(net.ajcloud.wansview.R.styleable.ScaleFrameLayout_dragSlideRangeX, 300);
        typedArray.recycle();
