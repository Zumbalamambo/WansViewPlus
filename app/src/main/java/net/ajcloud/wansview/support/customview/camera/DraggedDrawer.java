...
public class DraggedDrawer extends ViewGroup {
    ...
    public DraggedDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, net.ajcloud.wansview.R.styleable.Drawer, 0, 0);
        try {
            mDrawerType = a.getInt(net.ajcloud.wansview.R.styleable.Drawer_type, DRAWER_LEFT);
            mHandleId = a.getResourceId(net.ajcloud.wansview.R.styleable.Drawer_handleId, -1);
            mContentId = a.getResourceId(net.ajcloud.wansview.R.styleable.Drawer_contentId, -1);
            mShadowDrawable = a.getDrawable(net.ajcloud.wansview.R.styleable.Drawer_shadow);
            mEdgeDraggable = a.getBoolean(net.ajcloud.wansview.R.styleable.Drawer_edgeDraggable, false);
