package net.ajcloud.wansview.main.service;
...
public class GoogleFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        WLog.d(TAG, "From: " + remoteMessage.getFrom());
    ...
    private void sendNotification(String messageBody) {
        ...
        String channelId = getString(net.ajcloud.wansview.R.string.default_notification_channel_id);
