...
public class DynamicView /*implements ResponseListener*/ {
    ...
    public View getView() {
        view = View.inflate(context, net.ajcloud.wansview.R.layout.view_dynamic, null);
        ...
        imageViewOne = (ImageView) view.findViewById(net.ajcloud.wansview.R.id.caution_img_one);
        imageViewTwo = (ImageView) view.findViewById(net.ajcloud.wansview.R.id.caution_img_two);
        textViewOne = (TextView) view.findViewById(net.ajcloud.wansview.R.id.time_one);
        textViewTwo = (TextView) view.findViewById(net.ajcloud.wansview.R.id.time_two);
        more = (ImageView) view.findViewById(net.ajcloud.wansview.R.id.more);
