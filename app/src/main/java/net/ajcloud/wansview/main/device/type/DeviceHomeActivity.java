package net.ajcloud.wansview.main.device.type;
...
public class DeviceHomeActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return net.ajcloud.wansview.R.layout.activity_ws_device_home;
    }
    ...
    private boolean updataFragment(BaseFragment baseFragment) {
        try {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(net.ajcloud.wansview.R.id.cameraFragment, baseFragment, "fragment")
