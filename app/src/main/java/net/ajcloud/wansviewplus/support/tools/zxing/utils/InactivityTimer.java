...
package net.ajcloud.wansviewplus.support.tools.zxing.utils;
...
public class InactivityTimer {
    ...
    public synchronized void onPause() {
        ...
        if (registered) {
            ...
            WLog.w(TAG, "PowerStatusReceiver was never registered?");
        }
    }

    public synchronized void onResume() {
        if (registered) {
            WLog.w(TAG, "PowerStatusReceiver was already registered?");
        } else {
    ...
    private class InactivityAsyncTask extends AsyncTask<Object, Object, Object> {
        ...
        protected Object doInBackground(Object... objects) {
            try {
                ...
                WLog.i(TAG, "Finishing activity due to inactivity");
                activity.finish();
