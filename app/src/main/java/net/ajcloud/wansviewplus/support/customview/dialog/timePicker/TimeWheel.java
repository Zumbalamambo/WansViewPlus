package net.ajcloud.wansviewplus.support.customview.dialog.timePicker;

import android.content.Context;
import android.view.View;

import net.ajcloud.wansviewplus.R;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.adapters.NumericWheelAdapter;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.config.PickerConfig;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.source.TimeRepository;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.utils.PickerContants;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.utils.Utils;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.wheel.OnWheelChangedListener;
import net.ajcloud.wansviewplus.support.customview.dialog.timePicker.wheel.WheelView;

import java.util.Calendar;

import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.config.DefaultConfig.YEAR;
import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.Type.ALL;
import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.Type.HOURS_MINS;
import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.Type.MONTH_DAY_HOUR_MIN;
import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.Type.YEAR_MONTH;
import static net.ajcloud.wansviewplus.support.customview.dialog.timePicker.data.Type.YEAR_MONTH_DAY;
