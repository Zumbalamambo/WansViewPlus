 ...
 */
package net.ajcloud.wansviewplus.support.core.okgo.adapter;

import net.ajcloud.wansviewplus.support.core.okgo.adapter.Call;
import net.ajcloud.wansviewplus.support.core.okgo.cache.CacheEntity;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.CachePolicy;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.DefaultCachePolicy;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.FirstCacheRequestPolicy;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.NoCachePolicy;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.NoneCacheRequestPolicy;
import net.ajcloud.wansviewplus.support.core.okgo.cache.policy.RequestFailedCachePolicy;
import net.ajcloud.wansviewplus.support.core.okgo.callback.Callback;
 ...
 * ================================================
 */
public class CacheCall<T> implements net.ajcloud.wansviewplus.support.core.okgo.adapter.Call<T> {
