 ...
 */
package net.ajcloud.wansviewplus.support.core.okgo.db;
...
import net.ajcloud.wansviewplus.support.core.okgo.cookie.SerializableCookie;
import net.ajcloud.wansviewplus.support.core.okgo.db.ColumnEntity;
import net.ajcloud.wansviewplus.support.core.okgo.db.DBUtils;
import net.ajcloud.wansviewplus.support.core.okgo.db.TableEntity;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (net.ajcloud.wansviewplus.support.core.okgo.db.DBUtils.isNeedUpgradeTable(db, cacheTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_CACHE);
        if (net.ajcloud.wansviewplus.support.core.okgo.db.DBUtils.isNeedUpgradeTable(db, cookieTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_COOKIE);
        if (net.ajcloud.wansviewplus.support.core.okgo.db.DBUtils.isNeedUpgradeTable(db, downloadTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_DOWNLOAD);
