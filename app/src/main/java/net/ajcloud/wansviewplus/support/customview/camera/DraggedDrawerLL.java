...
public class DraggedDrawerLL extends LinearLayout {
    ...
    public DraggedDrawerLL(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, net.ajcloud.wansviewplus.R.styleable.Drawer, 0, 0);
        try {
            mDrawerType = a.getInt(net.ajcloud.wansviewplus.R.styleable.Drawer_type, DRAWER_LEFT);
            mHandleId = a.getResourceId(net.ajcloud.wansviewplus.R.styleable.Drawer_handleId, -1);
            mContentId = a.getResourceId(net.ajcloud.wansviewplus.R.styleable.Drawer_contentId, -1);
            mShadowDrawable = a.getDrawable(net.ajcloud.wansviewplus.R.styleable.Drawer_shadow);
            mEdgeDraggable = a.getBoolean(net.ajcloud.wansviewplus.R.styleable.Drawer_edgeDraggable, false);
