...
public class NavigationPopupWindow implements View.OnClickListener {
    ...
    public void initView() {
        view = View.inflate(context, net.ajcloud.wansviewplus.R.layout.popup_window_navigation, null);
        mobileTracker = (ToggleButton) view.findViewById(net.ajcloud.wansviewplus.R.id.mobile_tracker);
        mobileTracker.setChecked(state);
        mobileTracker.setOnClickListener(this);
        upDownNavigation = (TextView) view.findViewById(net.ajcloud.wansviewplus.R.id.up_down_navigation);
        leftRightNavigation = (TextView) view.findViewById(net.ajcloud.wansviewplus.R.id.left_right_navigation);
        stopNavigation = (TextView) view.findViewById(net.ajcloud.wansviewplus.R.id.stop_navigation);
        dismissImg = (ImageView) view.findViewById(net.ajcloud.wansviewplus.R.id.dismiss_img);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case net.ajcloud.wansviewplus.R.id.mobile_tracker:
                if (!listener.mobileTrackerSwitch(mobileTracker.isChecked())) {
                    popupWindow.dismiss();
                }
                break;
            case net.ajcloud.wansviewplus.R.id.up_down_navigation:
                ...
                break;
            case net.ajcloud.wansviewplus.R.id.left_right_navigation:
                ...
                break;
            case net.ajcloud.wansviewplus.R.id.stop_navigation:
                upDownNavigation.setSelected(false);
                leftRightNavigation.setSelected(false);
                ...
                break;
            case net.ajcloud.wansviewplus.R.id.dismiss_img:
                popupWindow.dismiss();
                break;
        }
    }
