 ...
 */
package net.ajcloud.wansviewplus.support.core.okgo.cache;
...
public class CacheEntity<T> implements Serializable {
     ...
     * @return 是否过期
     */
    public boolean checkExpire(net.ajcloud.wansviewplus.support.core.okgo.cache.CacheMode cacheMode, long cacheTime, long baseTime) {
