 ...
 */
package com.ajcloud.wansview.support.core.okhttp.db;
...
import com.ajcloud.wansview.support.core.okhttp.cookie.SerializableCookie;
import com.ajcloud.wansview.support.core.okhttp.db.ColumnEntity;
import com.ajcloud.wansview.support.core.okhttp.db.DBUtils;
import com.ajcloud.wansview.support.core.okhttp.db.TableEntity;
import com.ajcloud.wansview.support.core.okhttp.model.Progress;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (com.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, cacheTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_CACHE);
        if (com.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, cookieTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_COOKIE);
        if (com.ajcloud.wansview.support.core.okhttp.db.DBUtils.isNeedUpgradeTable(db, downloadTableEntity)) db.execSQL("DROP TABLE IF EXISTS " + TABLE_DOWNLOAD);
