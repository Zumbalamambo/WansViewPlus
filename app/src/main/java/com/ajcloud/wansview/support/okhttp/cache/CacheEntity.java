 ...
 */
package com.ajcloud.wansview.support.okhttp.cache;
...
public class CacheEntity<T> implements Serializable {
     ...
     * @return 是否过期
     */
    public boolean checkExpire(com.ajcloud.wansview.support.okhttp.cache.CacheMode cacheMode, long cacheTime, long baseTime) {
