...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions(Context context) {
        ...
        final boolean timeStrechingDefault = MainApplication.getApplication().getResources().getBoolean(R.bool.time_stretching_default);
        ...
        String chroma = pref.getString("chroma_format",  MainApplication.getApplication().getResources().getString(R.string.chroma_format_default));
