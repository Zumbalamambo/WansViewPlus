...
public class Media extends VLCObject<Media.Event> {
    ...
    public void setHWDecoderEnabled(boolean enabled, boolean force) {
        ...
        if(VideoEncryptionInfo.getVideoEncryptionInfo().isEncryptenabled()){
            addOption(":encrypt-mode=" + VideoEncryptionInfo.getVideoEncryptionInfo().getEncryptmode());
            addOption(":camera-id=" + VideoEncryptionInfo.getVideoEncryptionInfo().getOid());
            addOption(":mac-addr=" + VideoEncryptionInfo.getVideoEncryptionInfo().getMac());
            addOption(":session-key=" + VideoEncryptionInfo.getVideoEncryptionInfo().getSessionkey());
        }
